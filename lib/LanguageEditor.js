...
function LanguageEditor({ defaultRowPerPage = 5, onSave, onDelete }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsxs)(material_1.Stack, { direction: "row", gap: 2, sx: { py: 2, px: 1 }, children: [(0, jsx_runtime_1.jsx)(material_1.Autocomplete, { disablePortal: true, options: i18n?.languages ?? [], value: selectLanguage, disableClearable: true, size: "small", onChange: (_, v) => setSelectLanguage(v), sx: { width: 300 }, renderInput: (params) => (0, jsx_runtime_1.jsx)(material_1.TextField, { ...params, label: t("language-editor:select-language-label") }) }), (0, jsx_runtime_1.jsx)(material_1.Autocomplete, { disablePortal: true, disableClearable: true, size: "small", value: selectNamespace, onChange: (_, v) => setSelectNamespace(v), 
                        //@ts-ignore
                        options: Object.keys(i18n.getDataByLanguage(selectLanguage)), sx: { width: 300 }, renderInput: (params) => (0, jsx_runtime_1.jsx)(material_1.TextField, { ...params, label: t("language-editor:select-namespace-label") }) })] }), (0, jsx_runtime_1.jsx)(EditableTable_1.default, { defaultRowPerPage: defaultRowPerPage, language: selectLanguage, namespace: selectNamespace, data: tableData, onSave: (key, value) => onSave(selectLanguage, selectNamespace, key, value), onDelete: (keys) => onDelete(selectLanguage, selectNamespace, keys) })] }));
}
