...
function LanguageSelector() {
    ...
    return (<Autocomplete_1.default disablePortal disableClearable size="small" value={selectLanguage} onChange={(_, v) => setSelectLanguage(v)} 
    //@ts-ignore
    options={i18n?.languages ?? []} sx={{ width: 300 }} renderInput={(params) => <TextField_1.default {...params} label={t("language-editor:language-selector-label")}/>}/>);
}
