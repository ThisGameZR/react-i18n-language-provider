...
function AlertDialog({ open, setOpen, title, content, cancelText, confirmText, onConfirm, }) {
    ...
    return (<Dialog_1.default open={open} onClose={handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
      <DialogTitle_1.default id="alert-dialog-title">{title}</DialogTitle_1.default>
      ...
      <DialogActions_1.default>
        <Button_1.default onClick={handleClose}>{cancelText}</Button_1.default>
